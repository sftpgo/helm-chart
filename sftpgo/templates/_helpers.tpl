...
{{- if .Values.image.tag }}
app.kubernetes.io/version: {{ regexReplaceAll "[^-A-Za-z0-9_.]" .Values.image.tag "_" | trimPrefix "v" | trunc 63 | trimSuffix "-" | trimSuffix "_" | trimSuffix "." | quote }}
...
*/}}
{{- define "sftpgo.configMapOrSecretContentHash" -}}
{{- $data := list -}}
