...
| podMonitor | object | `{"annotations":{},"enabled":false,"interval":"1m","labels":{},"metricRelabelings":[],"relabelings":[],"scrapeTimeout":"10s"}` | Prometheus PodMonitor configuration. See the [Prometheus Operator documentation](https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.PodMonitor) for details. |
...
| podMonitor.metricRelabelings | list | `[]` | [Relabeling rules](https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.RelabelConfig) applied to samples before ingestion. |
| podMonitor.relabelings | list | `[]` | [Relabeling rules](https://prometheus-operator.dev/docs/api-reference/api/#monitoring.coreos.com/v1.RelabelConfig) applied to scrape targets before scraping. |
